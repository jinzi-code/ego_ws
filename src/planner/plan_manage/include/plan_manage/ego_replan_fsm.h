...
namespace ego_planner
{
  ...
  private:
    ...
    double collision_check_time_horizon_;
    double collision_check_time_step_;
    int collision_check_max_steps_;
    ...
    rclcpp::Publisher<std_msgs::msg::UInt8>::SharedPtr adjust_cmd_pub_;
    rclcpp::Publisher<nav_msgs::msg::Odometry>::SharedPtr odom_adjust_pub_;
    rclcpp::Publisher<std_msgs::msg::UInt8>::SharedPtr dir_pub;
    rclcpp::Publisher<std_msgs::msg::UInt8>::SharedPtr stop_pub;
