...
namespace ego_planner
{
    ...
    void EGOPlannerManager::initPlanModules(const rclcpp::Node::SharedPtr &nh, PlanningVisualization::Ptr vis)
    {
        node_ = nh;
        ...
        param("manager/max_vel", pp_.max_vel_, -1.0);
        param("manager/max_acc", pp_.max_acc_, -1.0);
        param("manager/max_jerk", pp_.max_jerk_, -1.0);
        param("manager/feasibility_tolerance", pp_.feasibility_tolerance_, 0.0);
        param("manager/control_points_distance", pp_.ctrl_pt_dist, -1.0);
        param("manager/planning_horizon", pp_.planning_horizen_, 5.0);
